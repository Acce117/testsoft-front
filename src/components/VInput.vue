    ...
    <Field v-model="model" :name="props.name" v-slot="{ meta, errors }">
      <FloatLabel variant="on">
        ...
        <Textarea v-else-if="props.textarea" v-bind="{ ...$attrs }" fluid v-model="model"
          :invalid="meta.validated && !meta.valid" />
        <InputMask v-else-if="$attrs.mask" toggle-mask :mask="$attrs.mask" fluid v-bind="{ ...$attrs }" v-model="model"
          :invalid="meta.validated && !meta.valid" />
        <Password v-else-if="props.password" toggle-mask :feedback="false" fluid v-bind="{ ...$attrs }" v-model="model"
          :invalid="meta.validated && !meta.valid" />
